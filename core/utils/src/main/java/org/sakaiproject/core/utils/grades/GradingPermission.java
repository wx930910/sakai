 ...
 */
package org.sakaiproject.core.utils.grades;
...
public enum GradingPermission {
	...
	public static List<String> getStandardPermissions() {
		...
		rval.add(GradingPermission.VIEW.toString());
		rval.add(GradingPermission.GRADE.toString());
		return rval;
	}
