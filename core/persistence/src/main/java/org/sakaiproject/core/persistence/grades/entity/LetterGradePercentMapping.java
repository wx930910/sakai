 ...
 */
package org.sakaiproject.core.persistence.grades.entity;
...
public class LetterGradePercentMapping implements Serializable {
    ...
    private static final String SEQUENCE_GENERATOR = "grading_letter_mapping_sequence";

    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = SEQUENCE_GENERATOR, sequenceName = "GB_LETTER_MAPPING_S")
