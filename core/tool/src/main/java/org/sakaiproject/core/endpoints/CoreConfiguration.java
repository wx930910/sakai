...
public class CoreConfiguration implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        rootContext.register(Core.class);
        ...
        Dynamic servlet = servletContext.addServlet("sakai.core", new DispatcherServlet(rootContext));
