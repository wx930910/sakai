...
public interface GradingPermissionService {
   ...
   */
    public Map<String, String> getStudentsForItem(Long gradebookId, String userId, List<String> studentIds, int cateType, Long categoryId, List<CourseSection> courseSections) throws IllegalArgumentException;
...
/**
   ...
   * @return Map of student IDs with grade/view as function value
   */
    public Map<String, String> getStudentsForItem(String gradebookUid, String userId, List<String> studentIds, int cateType, Long categoryId, List<CourseSection> courseSections) throws IllegalArgumentException;
   ...
   */
     ...
     /**
       ...
       * @return Map of item IDs with grade/view as function value
       */
         public Map getAvailableItemsForStudent(Long gradebookId, String userId, String studentId, Collection<CourseSection> courseSections) throws IllegalArgumentException;
