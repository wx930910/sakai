...
public class FilterPipeTest extends TestCase {
	...
	public void testReplace() {
		...
		Filter f1 = MockReplacedFilter.mockFilter1();
		...
		assertTrue("MockReplacedFilter is removed from FilterPipe",
				-1 == fp.index("org.radeox.test.filter.mock.MockReplacedFilter"));
		assertTrue("MockReplacesFilter is not removed from FilterPipe",
				-1 != fp.index("org.radeox.test.filter.mock.MockReplacesFilter"));
	}
}
